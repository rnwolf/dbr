...
def test_work_item_creation():
    ...
    try:
        ...
        with SessionLocal() as session:
            ...
            from dbr.models.collection import CollectionType, CollectionStatus
            ...
            expected_throughput = work_item.estimated_sales_price - work_item.estimated_variable_cost
