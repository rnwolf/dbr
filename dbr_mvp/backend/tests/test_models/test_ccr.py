...
def test_ccr_creation():
    ...
    try:
        ...
        with SessionLocal() as session:
            ...
            ccr_types = [
                (CCRType.SKILL_BASED, "Senior Developers", "Experienced software developers", 40.0),
                (CCRType.TEAM_BASED, "QA Team", "Quality assurance team", 80.0),
                (CCRType.EQUIPMENT_BASED, "Build Servers", "CI/CD build infrastructure", 168.0),
            ]
            ...
            for ccr_type, name, description, capacity in ccr_types:
                ...
                if ccr.time_unit == "week":
                    ...
                    assert monthly_capacity == capacity * 4.33  # Approximate weeks per month
    ...
    try:
        ...
        with SessionLocal() as session:
            ...
            work_item_data = [
                ...
                ("Feature B", {"senior_developers": 15.0, "qa_engineers": 8.0, "devops_team": 5.0}),
