...
class Analytics(BaseSDK):
    def get(
        ...
        *,
        ...
        request = (
            models.GetScheduleAnalyticsAPIV1SchedulesScheduleIDAnalyticsGetRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="get_schedule_analytics_api_v1_schedules__schedule_id__analytics_get",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.ScheduleAnalytics, http_res)
